...
public class ServicingCenter extends JFrame {
	static ServicingCenter frame;
	...
	public ServicingCenter() {
		...
		JLabel lblLibraryManagement = new JLabel("Gadget Servicing Center-Created by Riya Sarkar");
