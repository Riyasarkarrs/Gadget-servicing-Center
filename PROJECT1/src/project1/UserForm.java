...
public class UserForm extends JFrame {
	...
	public UserForm() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			if(i>0){
				JOptionPane.showMessageDialog(UserForm.this,"User Registered successfully!");
				LibrarianSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(UserForm.this,"Sorry, unable to register!");
			}
			}
		});
