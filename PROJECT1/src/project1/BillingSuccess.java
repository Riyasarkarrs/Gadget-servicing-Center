...
public class BillingSuccess extends JFrame {
	static BillingSuccess frame;
	...
	public BillingSuccess() {
		...
		JButton btnViewIssuedBooks = new JButton("FEEDBACK FORM");
		btnViewIssuedBooks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Feedback.main(new String[]{});
			}
		});
		...
		btnLogout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ServicingCenter.main(new String[]{});
				frame.dispose();
			}
		});
