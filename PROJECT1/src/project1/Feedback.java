...
public class Feedback extends JFrame {
	...
	public Feedback() {
		...
		JLabel lblNewLabel = new JLabel("YOUR FEEDBACK MATTERS!");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel.setForeground(Color.BLUE);
		
		JLabel lblBookName = new JLabel("YOUR ID");
		...
		JLabel lblStudentId = new JLabel("Customer Service:");
		
		JLabel lblStudentName = new JLabel("Backup Performance:");
		
		JLabel lblStudentContact = new JLabel("Helper Performance:");
		...
		btnIssueBook.addActionListener(new ActionListener() {
			...
			String CS=textField_2.getText();
			String BP=textField_3.getText();
			String HP=textField_4.getText();
			
			if(FeedbackDao.checkBook(callno)){
			
			int i=FeedbackDao.save(callno, CS, BP, HP);
			if(i>0){
				JOptionPane.showMessageDialog(Feedback.this,"FEEDBACK issued successfully!");
				LibrarianSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(Feedback.this,"PLEASE TRY ONCE MORE!");
			}//end of save if-else
			
			}else{
				JOptionPane.showMessageDialog(Feedback.this,"Sorry, IDno doesn't exist!");
		...
		JLabel lblNewLabel_1 = new JLabel("Note: Please check Gadget ID Carefully!");
